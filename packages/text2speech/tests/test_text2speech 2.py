...
def test_fish_mlx_provider_build_text():
    """Test the FishMLXProvider text building logic."""
    ...
    # Test with emotion
    req = Text2SpeechRequest(text="Hello", emotion="happy")
    assert provider._build_text(req) == "[happy] Hello"

    # Test with multiple tags
    req = Text2SpeechRequest(text="Hello", emotion="happy", tone="whisper")
    assert provider._build_text(req) == "[happy][whisper] Hello"
